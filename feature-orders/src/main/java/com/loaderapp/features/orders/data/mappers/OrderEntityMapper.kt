...
fun OrderApplicationEntity.toDomain(): OrderApplication =
    OrderApplication(
        orderId = orderId,
        loaderId = loaderId,
...
fun OrderApplication.toEntity(): OrderApplicationEntity =
...
fun OrderAssignmentEntity.toDomain(): OrderAssignment =
    OrderAssignment(
        orderId = orderId,
        loaderId = loaderId,
...
fun OrderAssignment.toEntity(): OrderAssignmentEntity =
...
fun String.toOrderApplicationStatus(): OrderApplicationStatus = runCatching { OrderApplicationStatus.valueOf(this) }.getOrDefault(OrderApplicationStatus.APPLIED)

fun String.toOrderAssignmentStatus(): OrderAssignmentStatus = runCatching { OrderAssignmentStatus.valueOf(this) }.getOrDefault(OrderAssignmentStatus.ACTIVE)
