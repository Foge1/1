...
sealed interface OrderActionBlockReason {
    ...
    data class ActionAllowedOnlyInStatus(
        val required: OrderStatus,
    ) : OrderActionBlockReason

    data class ActionAllowedOnlyInStatuses(
        val required: Set<OrderStatus>,
    ) : OrderActionBlockReason
    ...
    data class SelectedCountMismatch(
        val selected: Int,
        val required: Int,
    ) : OrderActionBlockReason
    ...
    data class UnsupportedEventForStatus(
        val event: OrderEvent,
        val status: OrderStatus,
    ) : OrderActionBlockReason
}

fun OrderActionBlockReason.toDisplayMessage(): String =
    when (this) {
