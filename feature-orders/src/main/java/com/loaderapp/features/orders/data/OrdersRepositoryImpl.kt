...
class OrdersRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun refresh() {
            ...
            val expiredCount =
                ordersDao.expireStaffingExactOrders(
        ...
        override suspend fun startOrder(
            ...
            db.withTransaction {
                ...
                val selectedApplications =
                    applicationsDao
                        .getApplicationsByOrder(orderId)
        ...
        override suspend fun getBusyAssignments(loaderIds: Collection<String>): Map<String, Long> {
            ...
            return assignmentsDao
                .findActiveAssignmentsByLoaders(
...
private suspend fun ApplicationsDao.countActiveApplicationsForLimit(
    ...
    countActiveApplicationsForLimit(
        loaderId = loaderId,
...
private suspend fun AssignmentsDao.updateAssignmentsStatusByOrder(
    orderId: Long,
...
private suspend fun AssignmentsDao.countAssignmentsByOrderLoaderAndStatuses(
    ...
    countAssignmentsByOrderLoaderAndStatuses(
        orderId = orderId,
        loaderId = loaderId,
