...
data class GetWorkerCountParams(
    val orderId: Long,
)

class GetWorkerCountUseCase
    @Inject
    constructor(
        private val orderRepository: OrderRepository,
    ) : FlowUseCase<GetWorkerCountParams, Flow<Int>>() {
        override fun execute(params: GetWorkerCountParams): Flow<Int> = orderRepository.getWorkerCountForOrder(params.orderId)
    }
